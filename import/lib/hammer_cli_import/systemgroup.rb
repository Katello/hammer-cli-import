...
module HammerCLIImport
  ...
  HammerCLI::MainCommand.subcommand("sg_import", "Import system groups command", HammerCLIImport::SystemGroupImportCommand)
  HammerCLI::MainCommand.subcommand("sg_remove", "Delete system groups command", HammerCLIImport::SystemGroupDeleteCommand)
end
